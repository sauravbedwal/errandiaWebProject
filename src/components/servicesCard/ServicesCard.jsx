...
{
  /* <div className="card serviceCard-container me-2 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mt-4 mb-4">
<div className="card-body">
  <div className="serviceCard-image-text">
    <div className="serviceCard-ImageContainer">
      <img
  ...
  <div className="serviceCard-buttons">
    <Button variant="primary" className="service-call-button">
      <img src={productsCall} alt="whatsappIcon" />
      Call
    </Button>
    <Button
