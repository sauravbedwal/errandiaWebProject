...
const UserProfileEditService = () => {
  const userProfileEditServiceModalBoolean = useSelector(
    (store) => store?.userProfileEditService?.value
  );
  ...
  return (
    <>
      <Modal
        size="lg"
        show={userProfileEditServiceModalBoolean}
      ...
      >
        <Modal.Header
          ...
          onClick={() => {
            ...
            dispatch(setUserProfileEditServiceModalFalse());
          }}
        >
          <Modal.Title
...
export default UserProfileEditService;
